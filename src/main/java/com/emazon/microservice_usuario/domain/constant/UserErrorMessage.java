...
public final class UserErrorMessage {
    ...
    public static final String USER_NAME_CHARACTER = "The name must be between 2 and 150 characters long and cannot be empty.";
    public static final String USER_LAST_NAME_CHARACTER = "The last name must be between 2 and 200 characters long and cannot be left blank.";
    ...
    public static final String USER_PHONE_NUMBER = "The phone number cannot be longer than 14 characters and cannot be left blank.";
